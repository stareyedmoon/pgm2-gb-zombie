...
typedef struct {
    ...
    // This affects how often you get vital crits and misses, and limits what weapons can be used.
    ...
    // This affects base damage, and limits what weapons can be used.
    ...
    // This affects turn order and how often you get crits.
    // For more detail on turn order see lib/game/encounter.c
